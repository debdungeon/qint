...
"ERR_BAD_PART:Sorry, a message part has an unacceptable MIME Content-Type: '<#1#>' (#5.2.3)\0"
"ERR_BAD_REQUEST:Illegal request format (#5.7.1)\0"
"ERR_BAD_RETURN_ADDRESS:Invalid bounce or receipt address format (#5.1.1)\0"
"ERR_BAD_TYPE:Sorry, I don't accept messages of MIME Content-Type '<#1#>' (#5.2.3)\0"
...
"ERR_CFHOST:bounce-host required on first line of <#1#>\0"
...
"ERR_CHMOD:unable to chmod <#1#>\0"
"ERR_CHROOT:failed to chroot to <#1#>\0"
"ERR_CLOSE:unable to close <#1#>\0"
"ERR_COOKIE:message does not have valid authentication token\0"
"ERR_CREATE:unable to create <#1#>\0"
"ERR_CRONTAB:crontab update failed. Contact your sysadmin with the above error information\0"
"ERR_DELETE:unable to delete <#1#>\0"
...
"ERR_EXECUTE:unable to execute <#1#>\0"
"ERR_EXTRA_SUB:Processed SENDER check addition request for: <#1#>\0"
"ERR_EXTRA_UNSUB:Processed SENDER check removal request for: <#1#>\0"
"ERR_FILENAME:continuation tag without defined file name: <#1#>\0"
"ERR_FLUSH:unable to flush <#1#>\0"
"ERR_FLUSH_STDOUT:unable to flush standard output\0"
"ERR_FORK:unable to fork\0"
"ERR_JUNK:Precedence: junk - message ignored\0"
"ERR_LINKDIR:linktag lacks /dir: <#1#>\0"
...
"ERR_MAX_SIZE:Sorry, I don't accept messages larger than <#1#> bytes (#5.2.3)\0"
"ERR_MIME_QUOTE:MIME boundary lacks end quote\0"
"ERR_MIN_SIZE:Sorry, I don't accept messages shorter than <#1#> bytes (#5.2.3)\0"
...
"ERR_MOVE:unable to move <#1#> to <#2#>\0"
...
"ERR_OBTAIN_LOCK:unable to obtain lock on <#1#>\0"
"ERR_OPEN:unable to open <#1#>\0"
"ERR_OPEN_LISTMSGS:unable to open <#1#> in listmsgs. Rerun ezmlm-archive!\0"
"ERR_PERIOD:periods not allowed in tags\0"
"ERR_QMAIL_QUEUE:unable to run qmail-queue\0"
"ERR_QUOTE:quotes not allowed in dir\0"
"ERR_READ:unable to read <#1#>\0"
"ERR_READ_INPUT:unable to read input\0"
"ERR_READ_NOTHING:unable to read <#1#>: nothing there\0"
"ERR_READ_STDIN:unable to read standard input\0"
...
"ERR_SUBSCRIBER_CAN:only subscribers can <#1#> (#5.7.1)\0"
...
"ERR_SYNC:unable to sync <#1#>\0"
"ERR_SYNTAX:syntax error in <#1#>\0"
"ERR_SYNTAX_CONFIG:syntax error in config file <#1#>\0"
"ERR_SYNTAX_MISSING_AUTHHASH: syntax error: <#1#>: missing author hash\0"
"ERR_SYNTAX_MISSING_AUTHOR: syntax error: <#1#>: author info missing.\0"
"ERR_SYNTAX_MISSING_FIRST: syntax error: <#1#>: first line missing\0"
"ERR_SYNTAX_MISSING_SEMIDATE: syntax error: <#1#>: missing \";\" after date\0"
"ERR_SYNTAX_MISSING_SEPARATOR: syntax error: <#1#>: missing subject separator\0"
"ERR_SYNTAX_MISSING_SUBJHASH: syntax error: <#1#>: missing subject hash\0"
...
"ERR_WRITE:unable to write <#1#>\0"
"ERR_WRITE_STDOUT:unable to write to standard output\0"
"SUB_CONFIRM_POST:Confirm post to <#L#>@<#H#>\0"
"SUB_EDIT_LIST:List of editable text files for <#L#>@<#H#>\0"
"SUB_EDIT_REQUEST:EDIT <#1#> for <#L#>@<#H#>\0"
"SUB_EDIT_SUCCESS:Success editing <#1#> for <#L#>@<#H#>\0"
"SUB_FAQ:FAQ for <#L#>@<#H#>\0"
"SUB_GET_MSG:Archive retrieval from <#L#>@<#H#>\0"
"SUB_GOODBYE:GOODBYE from <#L#>@<#H#>\0"
"SUB_HELP:Help for <#L#>@<#H#>\0"
"SUB_INFO:Information for <#L#>@<#H#>\0"
"SUB_LIST:Subscriber list for <#L#>@<#H#>\0"
"SUB_LOG:Subscriber log for <#L#>@<#H#>\0"
"SUB_LOG_SEARCH:Log search results for <#L#>@<#H#>\0"
"SUB_MODERATE:MODERATE for <#L#>@<#H#>\0"
"SUB_MOD_HELP:Moderator help for <#L#>@<#H#>\0"
"SUB_MOD_SUBSCRIBE:CONFIRM subscribe to <#L#>@<#H#>\0"
"SUB_MOD_UNSUBSCRIBE:CONFIRM unsubscribe from <#L#>@<#H#>\0"
"SUB_PROBE:Probe from <#L#>@<#H#>\0"
"SUB_RESULTS:<#L#> results\0"
"SUB_RETURNED_POST:Returned post for <#L#>@<#H#>\0"
"SUB_STATUS:Subscription status on <#L#>@<#H#>\0"
"SUB_SUBSCRIBE_NOP:Already subscribed to <#L#>@<#H#>\0"
"SUB_UNSUBSCRIBE_NOP:Not subscribed to <#L#>@<#H#>\0"
"SUB_USR_SUBSCRIBE:confirm subscribe to <#L#>@<#H#>\0"
"SUB_USR_UNSUBSCRIBE:confirm unsubscribe from <#L#>@<#H#>\0"
"SUB_WARNING:Warning from <#L#>@<#H#>\0"
"SUB_WELCOME:WELCOME to <#L#>@<#H#>\0"
"TXT_ADMINISTRIVIA:Administrivia:\0"
"TXT_BY:by: <#1#>\0"
"TXT_EDIT_END:%%% END OF TEXT FILE\0"
"TXT_EDIT_START:%%% START OF TEXT FILE\0"
"TXT_LISTMEMBERS:Subscribers to this list are:\0"
"TXT_MAILING_LIST:contact <#L#>-help@<#H#>; run by ezmlm\0"
"TXT_NOINDEX:aaaaaaaaaaaaaaaaaaaa <- subject index not available for message(s) ->\0"
"TXT_ONLY_SUBSCRIBERS:Sorry, only subscribers may post. If you are a subscriber, please forward this message to <#L#>-owner@<#H#> to get your new address included.\0"
"TXT_REJECT_POSTS:Sorry, I've been told to reject your posts. Contact <#L#>-owner@<#H#> if you have questions about this.\0"
"TXT_SUPPRESSED:<suppressed>\0"
"TXT_TOP_TOPICS:Topics (messages <#1#> through <#2#>)\0"
